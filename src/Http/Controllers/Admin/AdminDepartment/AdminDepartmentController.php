...
namespace Qz\Http\Controllers\Admin\AdminDepartment;

use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Illuminate\Support\Arr;
use Qz\Cores\AdminDepartment\AdminDepartmentAdd;
use Qz\Cores\AdminDepartment\AdminDepartmentDelete;
use Qz\Cores\AdminDepartment\AdminDepartmentUpdate;
use Qz\Cores\AdminDepartment\GetSubAdminDepartmentIdsByAdminDepartmentIds;
use Qz\Cores\AdminDepartment\GetTreeDepartmentList;
use Qz\Exceptions\MessageException;
